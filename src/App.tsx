  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-b from-white to-slate-50 text-slate-800">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-5 right-5 rounded-full shadow-xl p-3 bg-[#25D366] text-white hover:scale-105 transition-transform outline-none active:scale-95 select-none"
        aria-label="WhatsApp"
